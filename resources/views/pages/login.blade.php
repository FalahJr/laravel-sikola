                ...
                <div
                    ...
                    <div class="m-3 p-4">
                        <div class="d-flex align-items-center  mb-5">
                            ...
                            <h2 class="text-dark font-weight-normal ml-4">Sikola App
                            </h2>
                        </div>

                        <a href="{{ route('login-student') }}"
                            class="btn btn-primary btn-lg btn-icon icon-right mt-3 mr-4" tabindex="4">
                            Login as a Student
                        </a>
                        <a href="{{ route('login-teacher') }}" class="btn btn-light btn-lg btn-icon icon-right mt-3 "
                            tabindex="4">
                            Login as a Teacher
                        </a>
                        {{-- <form method="POST" action="#" class="needs-validation" novalidate="">
                            ...
                            <div class="mt-5 text-center">
                                Don't have an account? <a href="auth-register.html">{{ __('Create new one') }}</a>
                            </div>
                        </form> --}}
