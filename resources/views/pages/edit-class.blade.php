                            ...
                            <form class="form" action="/teacher/classes/{{ $class->id }}" method="post">
                                ...
                                <div class="card-body">
                                    <div class="form-group row mb-4">
                                        <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Class
                                            Name</label>
                                        <div class="col-sm-12 col-md-7">
                                            <input type="text" class="form-control" name="name"
                                                value="{{ $class->name }}"
                                                placeholder="Enter class name (e.g., X IPA 1, XI RPL 2)" required>
                                        </div>
                                    </div>
